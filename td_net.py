...
class ChannelAttention(tf.keras.layers.Layer):
    def __init__(self):
        ...
        self.dense_avg_1 = Dense(units=1024 // 8, activation='relu')
        self.dense_avg_2 = Dense(units=1024, activation='sigmoid')
        self.dense_max_1 = Dense(units=1024 // 8, activation='relu')
        self.dense_max_2 = Dense(units=1024, activation='sigmoid')
...
mobile_net_model = create_attention_model(MobileNet, input_shape=(224, 224, 3), name="MobileNet_with_Attention")
# dense_net_model = create_attention_model(DenseNet121, input_shape=(224, 224, 3), name="DenseNet_with_Attention")
# efficient_net_model = create_attention_model(EfficientNetB0, input_shape=(224, 224, 3), name="EfficientNet_with_Attention")
